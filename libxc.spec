...
export CFLAGS="%{optflags} -fno-var-tracking-assignments -mcmodel=medany"
...
%changelog
* Sat Aug 19 2023 Liu Yang <Yang.Liu.sn@gmail.com> - 5.1.7-2.rv64
- Using a compat version for riscv64.
